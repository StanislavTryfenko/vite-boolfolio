...
import { callApiProject } from '../../assets/apiCalls.js';
export default {
    name: "ProjectShow",
    data() {
        return {
    ...
    mounted() {
        callApiProject(state.backend +"project/" + this.$route.params.slug);
    }
}
</script>
        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="lg:w-4/6 mx-auto">
                <div class="rounded-lg h-64 overflow-hidden">
                    <img alt="content" class="object-cover object-center h-full w-full" :src="state.project.image">
                </div>
